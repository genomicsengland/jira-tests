...
Feature: End to end Jira flow
  ...
  @JiraWorkflow1
  Scenario Outline: Login to the System Dashboard and create a ticket for issue type "Task" and workflow transition In Progress, Done and Selected for Development
  ...
  @JiraWorkflow2
  Scenario Outline: Login to the System Dashboard and create a ticket for issue type "Test" and workflow transition In Progress, Done and Selected for Development
